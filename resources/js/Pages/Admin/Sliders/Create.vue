...
<template>
    <Head title="Add Hero Slider" />

    <AdminMaster>
        <div class="max-w-2xl mx-auto space-y-6">
            <div class="flex items-center justify-between">
                <div>
                    <h1 class="text-2xl font-bold text-gray-900 dark:text-white">Add Hero Slider</h1>
                    <p class="text-sm text-gray-500 dark:text-gray-400 mt-1">Upload a new image for the homepage slider</p>
                </div>
                ...
                <form @submit.prevent="submit" class="space-y-5">
                    ...
                    <div class="flex items-center gap-3 pt-2">
                        <button type="submit" :disabled="form.processing" class="px-6 py-2.5 bg-blue-600 text-white text-sm font-medium rounded-lg hover:bg-blue-700 disabled:opacity-50 transition shadow-sm">
                            {{ form.processing ? 'Uploading...' : 'Upload Slider' }}
                        </button>
