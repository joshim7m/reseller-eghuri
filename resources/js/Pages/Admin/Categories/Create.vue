        ...
        <div class="max-w-2xl mx-auto space-y-6">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-sm text-gray-500 dark:text-gray-400 mt-1">Add a new product category</p>
                </div>
            ...
            <div class="bg-white dark:bg-gray-900 rounded-xl shadow-sm border border-gray-200 dark:border-gray-800 p-6">
                <form @submit.prevent="submit" class="space-y-5">
                    ...
                    <div>
                        ...
                        <div v-if="hasImage" class="mt-3 relative inline-block group">
                            <img :src="imagePreview" alt="Preview" class="w-24 h-24 rounded-xl object-cover border border-gray-200 dark:border-gray-700 shadow-sm" />
                            <button type="button" @click="removeImage" class="absolute -top-1.5 -right-1.5 w-5 h-5 bg-red-500 text-white rounded-full flex items-center justify-center opacity-0 group-hover:opacity-100 transition text-xs font-bold">&times;</button>
                        </div>
                    </div>
