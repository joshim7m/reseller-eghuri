...
<template>
    ...
    <FrontEndMaster>
        <section class="mb-12 border-b border-outline-variant dark:border-[#3a302e]">
            ...
            <h1 class="text-3xl md:text-4xl lg:text-5xl font-bold text-charcoal dark:text-[#f9eeed] uppercase tracking-tight mb-4">New Arrivals</h1>
            <p class="text-on-surface-variant dark:text-[#cbb8b6] max-w-2xl">Check out our latest products, fresh styles just landed.</p>
        </section>
        ...
        <div class="flex gap-6">
            ...
            <div class="flex-1 min-w-0">
                ...
                <div v-else class="text-center py-20">
                    ...
                    <p class="text-on-surface-variant dark:text-[#cbb8b6] text-sm">No new arrivals yet.</p>
                </div>
